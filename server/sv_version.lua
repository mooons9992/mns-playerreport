...
local repositoryUrl = 'https://github.com/mooons9992/mns-playerreport'
local versionCheckEndpoint = 'https://raw.githubusercontent.com/mooons9992/mns-playerreport/main/version.json'
